...
def seed_data(apps, schema_editor):
        iva.models.Imputacion.objects.create(imputacion='Mov. entre cuentas', activo=True)
        shared.models.Moneda.objects.create(nombre='BRL', activo=True)
        shared.models.Moneda.objects.create(nombre='USD', activo=True)

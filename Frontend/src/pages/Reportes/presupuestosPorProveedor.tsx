...
import { get_presupuestos_por_proveedor } from '@/endpoints/api'
...
export function PresupuestosPorProveedor() {
    ...
    return (
        <div className="mx-auto p-4 w-full">
            <div className="flex items-center mb-2">
                ...
                <h1 className="text-2xl font-bold mb-4">Presupuestos por proveedor</h1>
            </div>
            <div className="flex flex-col md:flex-row gap-4 mb-4">
                ...
                <Button     
                    onClick={() => get_presupuestos_por_proveedor(entidadSeleccionada, true)}

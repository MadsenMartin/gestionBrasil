...
import { TablaGastosPorCasa } from '@/components/reportes/tablaGastosPorCasa'

export function GastosPorCasa() {
    ...
    return (
        <div className="mx-auto p-4 w-full">
            ...
            <h1 className="text-2xl font-bold mb-4">Gastos por casa</h1>
            </div>
            <div className="flex items-center justify-between mb-4">
                ...
                />
                {entidadSeleccionada && <Button onClick={() => get_gastos_por_casa(entidadSeleccionada, true)}>Exportar a Excel</Button>}
            </div>
            <Suspense fallback={<div>Cargando...</div>}>
                {entidadSeleccionada !== null &&
                    <div>
                        <TablaGastosPorCasa cliente_proyecto={entidadSeleccionada} />
                    </div>
                }
            </Suspense>
        </div>

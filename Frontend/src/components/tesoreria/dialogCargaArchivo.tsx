...
import { carga_archivo_registro } from "@/endpoints/api";
...
export function DialogCargaArchivo({registro, toast, trigger}: DialogCargaArchivoProps) {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            formData.append('registro', registro.toString());
            await carga_archivo_registro(formData);

...
export function ListadoConsumosPresupuesto({trigger, presupuesto}) {
    ...
    useEffect(() => {
        const fetchConsumos = async () => {
            if (showDialog) {
                ...
                const response = await get_generico_params({model: "consumos_presupuesto", params: { presupuesto: presupuesto.id }});
        ...
        <Dialog open={showDialog} onOpenChange={setShowDialog}>
            ...
            <DialogContent className="max-w-screen-2xl">
                <div className="p-4 flex justify-between">
                    <DialogTitle className="font-bold">Consumos del presupuesto</DialogTitle>
                ...
                {loading ? (
                    ...
                    <div className="p-4">
                        ...
                        <Table>
                            ...
                            <TableBody>
                                <TableRow>
                                    <TableCell colSpan={7} className="text-left font-bold">Presupuesto</TableCell>
                                    <TableCell className="font-bold">{formatCurrency(presupuesto.monto)}</TableCell>
                                </TableRow>
                                ...
                                <TableRow>
                                    <TableCell colSpan={7} className="text-left font-bold">Saldo actual</TableCell>
                                    <TableCell className="font-bold">{formatCurrency(presupuesto.saldo)}</TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                        </ScrollArea>
                </div>) :
                <div className="p-4 text-center">No hay consumos asociados a este presupuesto</div>}
